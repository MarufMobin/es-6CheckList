...
// const numberOfArray = [ 28, 447, 14, 47, 45, 74, 474, 2];
...
const outputTwo = (number1, number2) => (number1 + 2) * (number2 + 2);

// console.log(outputTwo( 3, 2 ))


// ৩.৩ এইবার তিনটা প্যারামিটার ওয়ালা একটা অ্যারো ফাংশন ডিক্লেয়ার করো। যেই ফাংশনের কাজ হবে তিনটা প্যারামিটার নিয়ে সেই তিনটা প্যারামিটারকে গুণ করে সেই রেজাল্ট রিটার্ন করবে। 

const outputThree = ( num1,num2,num3 ) =>{
   return  num1 * num2 * num3;
}

// console.log(outputThree( 2,4,2 ));
...
const outputFour = (num1 , num2) =>{
    const firstTask = num1 + 2;
    const secondTask = num2 + 2;
    return firstTask * secondTask;
}

// console.log(outputFour(2,3))